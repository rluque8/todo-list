...
exports.GENERAL_FORBIDDEN_ERROR = "You do not have enough permissions for the request";
exports.TOKEN_MISSING_ERROR = "Token missing from header";
// USER MESSAGES
exports.INTERNAL_SERVER_ERROR_USERS = "There was an error. Please, try again.";
exports.BAD_REQUEST_ERROR_USERS = "There is an error in the insertion format.";
exports.DUPLICATED_ERROR_USERS = "User already exist with given email.";
